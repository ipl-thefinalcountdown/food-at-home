    ...
    <b-navbar toggleable="lg" variant="light">
      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav>
          ...
          <div v-if="isAuthenticated">
            <b-nav-item v-if="authUser.type != 'C'" :to="{name: 'list-orders'}">Orders</b-nav-item>
          </div>
        ...
        <b-navbar-nav class="ml-auto">
          ...
          <b-nav-item-dropdown v-else right>
            ...
            <b-dropdown-item v-if="authUser.type == 'C'" :to="{name: 'list-profile-orders'}">My Orders</b-dropdown-item>
            <b-dropdown-item @click.prevent="handleLogout()">Sign Out</b-dropdown-item>
          </b-nav-item-dropdown>
          <b-nav-form v-if="isAuthenticated && authUser.type == 'C'">
            <b-button size="sm" class="my-2 my-sm-0" :to="{name: 'products-cart'}"><i class="fas fa-shopping-cart"></i> Cart ({{cartLength}})</b-button>
          </b-nav-form>
        </b-navbar-nav>
      </b-collapse>
    </b-navbar>
